...
app.controller("solutionmanagerCtrl_1_2",function($uibModal,$log,$scope,$state,$http,factory_cookie,jsonToStr,Upload){
	var ctrl = this;
	...
	$scope.solutionmanager_refresh = function() {
		$state.reload("workspace.solutionmanager_1_2");
	}
	//每页显示个数
