...
app.controller("solutionmanagerCtrl_2_1",function($filter,$uibModal,$log,$scope,$state,$http,factory_cookie,jsonToStr,Upload){
	var ctrl = this;
	...
	$scope.solutionmanager_refresh = function() {
		$state.reload("workspace.solutionmanager_2_1");
	}
	//每页显示个数
